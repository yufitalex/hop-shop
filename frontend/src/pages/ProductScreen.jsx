...
const handleSubmit =async (e)=>{
  ...
  try {
    ...
    toast('The review has been submitted')
    refetch()
  } catch (err) {
  ...
  return (
    <>
    <Link className='btn btn-light btn-outline my-3' to='/'>
  Go Back
</Link>
    { isLoading? 
      (<Loader/>)
  ...
  <>
  <Meta  description={product.description} keywords={product.name} title={product.name}/>
<Row>
  <Col md={5}>
